...
public final class ViewAnimationUtils {
    ...
    public static void invisibleViewByAlpha(final View view,
        ...
        if (view.getVisibility() != View.INVISIBLE) {
            ...
            AlphaAnimation hiddenAlphaAnimation = MyAnimationUtils
    ...
    public static void invisibleViewByAlpha(final View view,
        ...
        invisibleViewByAlpha(view, MyAnimationUtils.DEFAULT_ANIMATION_DURATION,
    ...
    public static void goneViewByAlpha(final View view,
                                       final boolean isBanClick, final AnimationListener animationListener) {
        goneViewByAlpha(view, MyAnimationUtils.DEFAULT_ANIMATION_DURATION,
                isBanClick, animationListener);
    }
    ...
    public static void goneViewByAlpha(final View view,
                                       final AnimationListener animationListener) {
        goneViewByAlpha(view, MyAnimationUtils.DEFAULT_ANIMATION_DURATION, false,
                animationListener);
    }
    ...
    public static void visibleViewByAlpha(final View view, long durationMillis,
        ...
        if (view.getVisibility() != View.VISIBLE) {
            ...
            AlphaAnimation showAlphaAnimation = MyAnimationUtils
    ...
    public static void visibleViewByAlpha(final View view,
                                          final boolean isBanClick, final AnimationListener animationListener) {
        visibleViewByAlpha(view, MyAnimationUtils.DEFAULT_ANIMATION_DURATION,
                isBanClick, animationListener);
    }
